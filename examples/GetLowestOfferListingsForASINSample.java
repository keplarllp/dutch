...
public class GetLowestOfferListingsForASINSample {
    ...
    public static void invokeGetLowestOfferListingsForASIN(MarketplaceWebServiceProducts service, GetLowestOfferListingsForASINRequest request) {
        try {
            ...
            System.out.println("    GetLowestOfferListingsForASINResponse");
            System.out.println();
            ...
            for (GetLowestOfferListingsForASINResult getLowestOfferListingsForASINResult : getLowestOfferListingsForASINResultList) {
                System.out.println("        GetLowestOfferListingsForASINResult");
                System.out.println();
            if (getLowestOfferListingsForASINResult.isSetASIN()) {
                System.out.println("        ASIN");
                System.out.println();
                System.out.println("            " + getLowestOfferListingsForASINResult.getASIN());
                System.out.println();
            } 
            if (getLowestOfferListingsForASINResult.isSetStatus()) {
                System.out.println("        status");
                System.out.println();
                System.out.println("            " + getLowestOfferListingsForASINResult.getStatus());
                System.out.println();
            } 
                if (getLowestOfferListingsForASINResult.isSetAllOfferListingsConsidered()) {
                    System.out.println("            AllOfferListingsConsidered");
                    System.out.println();
                    System.out.println("                " + getLowestOfferListingsForASINResult.isAllOfferListingsConsidered());
                    System.out.println();
                }
                ...
                if (getLowestOfferListingsForASINResult.isSetError()) {
                    ...
                    System.out.println();
                    com.amazonservices.mws.products.model.Error  error = getLowestOfferListingsForASINResult.getError();
                    if (error.isSetType()) {
