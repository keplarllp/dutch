...
public class GetCompetitivePricingForSKUSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Get Competitive Pricing For SKU 
         ***********************************************************************/
    ...
    public static void invokeGetCompetitivePricingForSKU(MarketplaceWebServiceProducts service, GetCompetitivePricingForSKURequest request) {
        try {
            ...
            System.out.println ("GetCompetitivePricingForSKU Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    GetCompetitivePricingForSKUResponse");
            System.out.println();
            java.util.List<GetCompetitivePricingForSKUResult> getCompetitivePricingForSKUResultList = response.getGetCompetitivePricingForSKUResult();
            for (GetCompetitivePricingForSKUResult getCompetitivePricingForSKUResult : getCompetitivePricingForSKUResultList) {
                System.out.println("        GetCompetitivePricingForSKUResult");
                System.out.println();
            if (getCompetitivePricingForSKUResult.isSetSellerSKU()) {
                System.out.println("        SellerSKU");
                System.out.println();
                System.out.println("            " + getCompetitivePricingForSKUResult.getSellerSKU());
                System.out.println();
            } 
            if (getCompetitivePricingForSKUResult.isSetStatus()) {
                System.out.println("        status");
                System.out.println();
                System.out.println("            " + getCompetitivePricingForSKUResult.getStatus());
                System.out.println();
            } 
                if (getCompetitivePricingForSKUResult.isSetProduct()) {
                    System.out.println("            Product");
                    System.out.println();
                    Product  product = getCompetitivePricingForSKUResult.getProduct();
                ...
                if (getCompetitivePricingForSKUResult.isSetError()) {
                    ...
                    System.out.println();
                    com.amazonservices.mws.products.model.Error  error = getCompetitivePricingForSKUResult.getError();
                    if (error.isSetType()) {
