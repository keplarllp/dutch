...
public class GetProductCategoriesForSKUAsyncSample {
    ...
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
         GetProductCategoriesForSKURequest requestOne = new GetProductCategoriesForSKURequest();
         // @TODO: set request parameters here

         GetProductCategoriesForSKURequest requestTwo = new GetProductCategoriesForSKURequest();
         // @TODO: set second request parameters here

         List<GetProductCategoriesForSKURequest> requests = new ArrayList<GetProductCategoriesForSKURequest>();
         requests.add(requestOne);
         requests.add(requestTwo);

         invokeGetProductCategoriesForSKU(service, requests);
     ...
     */
    public static void invokeGetProductCategoriesForSKU(MarketplaceWebServiceProductsAsync service, List<GetProductCategoriesForSKURequest> requests) {
        ...
        for (GetProductCategoriesForSKURequest request : requests) {
            responses.add(service.getProductCategoriesForSKUAsync(request));
        }
        for (Future<GetProductCategoriesForSKUResponse> future : responses) {
            ...
            try {
                ...
                GetProductCategoriesForSKURequest originalRequest = requests.get(responses.indexOf(future));
