...
public class GetMatchingProductSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Get Matching Product 
         ***********************************************************************/
    ...
    public static void invokeGetMatchingProduct(MarketplaceWebServiceProducts service, GetMatchingProductRequest request) {
        try {
            ...
            System.out.println ("GetMatchingProduct Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    GetMatchingProductResponse");
            System.out.println();
            java.util.List<GetMatchingProductResult> getMatchingProductResultList = response.getGetMatchingProductResult();
            for (GetMatchingProductResult getMatchingProductResult : getMatchingProductResultList) {
                System.out.println("        GetMatchingProductResult");
                System.out.println();
            if (getMatchingProductResult.isSetASIN()) {
                System.out.println("        ASIN");
                System.out.println();
                System.out.println("            " + getMatchingProductResult.getASIN());
                System.out.println();
            } 
            if (getMatchingProductResult.isSetStatus()) {
                System.out.println("        status");
                System.out.println();
                System.out.println("            " + getMatchingProductResult.getStatus());
                System.out.println();
            } 
                if (getMatchingProductResult.isSetProduct()) {
                    System.out.println("            Product");
                    System.out.println();
                    Product  product = getMatchingProductResult.getProduct();
                    ...
                    if (product.isSetAttributeSets()) {
                        ...
                        for (Object obj : attributeSetList.getAny()) {
                            ...
                            ProductsUtils.printNode(attribute);
                        }
                        System.out.println();
                    }
                    if (product.isSetRelationships()) {
                        ...
                        for (Object obj : relationships.getAny()) {
                            ...
                            ProductsUtils.printNode(relationship);
                        }
                        System.out.println();
                    }
                ...
                if (getMatchingProductResult.isSetError()) {
                    ...
                    System.out.println();
                    com.amazonservices.mws.products.model.Error  error = getMatchingProductResult.getError();
                    if (error.isSetType()) {
