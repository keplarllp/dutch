...
public class GetCompetitivePricingForASINAsyncSample {
     ...
     * Get Competitive Pricing For ASIN functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
         GetCompetitivePricingForASINRequest requestOne = new GetCompetitivePricingForASINRequest();
         // @TODO: set request parameters here

         GetCompetitivePricingForASINRequest requestTwo = new GetCompetitivePricingForASINRequest();
         // @TODO: set second request parameters here

         List<GetCompetitivePricingForASINRequest> requests = new ArrayList<GetCompetitivePricingForASINRequest>();
         requests.add(requestOne);
         requests.add(requestTwo);

         invokeGetCompetitivePricingForASIN(service, requests);
     ...
     */
    public static void invokeGetCompetitivePricingForASIN(MarketplaceWebServiceProductsAsync service, List<GetCompetitivePricingForASINRequest> requests) {
        ...
        for (GetCompetitivePricingForASINRequest request : requests) {
            responses.add(service.getCompetitivePricingForASINAsync(request));
        }
        for (Future<GetCompetitivePricingForASINResponse> future : responses) {
            ...
            try {
                ...
                GetCompetitivePricingForASINRequest originalRequest = requests.get(responses.indexOf(future));
